    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px] '>
            <div className='col-span-2'>
              ...
              <h3 className='py-2 text-[#6D737A]'>various versions have evolved over the years,<br></br> sometimes by accident</h3>
              <h3 className='py-2 text-[#6D737A]'>Email: example@lala.com</h3>
            ...
            <div className='max-[780px]:col-span-2'>
              ...
              <form className='py-4'>
                <input 
                  className='bg-[#F2F3F4] py-4 w-full rounded px-4' 
